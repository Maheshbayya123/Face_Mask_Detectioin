...
# Ensure the model is in H5 format and exists
model_path = "mask_detector.h5"
if not os.path.exists(model_path):
    print("[ERROR] Model file not found:", model_path)
    print("Ensure the model is converted to H5 format and located in the correct directory.")
    exit(1)

# Load face mask detector model with error handling
try:
...
if not vs.isOpened():
    print("[ERROR] Could not initialize camera. Ensure your camera is connected.")
    exit(1)
